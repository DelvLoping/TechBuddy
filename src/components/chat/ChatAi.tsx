...
//         try {
//             // Envoi du message de l'utilisateur à l'API
//             await axiosInstance.post('/ai-message', {
//                 aiChatId,
//                 content: input,
//                 sender: "USER",
...
//             const newMessages = [...messages, { id: Date.now(), content: input, sender: 'USER' }];
...
//     const [input, setInput] = useState('');
//     const [titleSet, setTitleSet] = useState(false);
//     const [backgroundColor, setBackgroundColor] = useState('white'); // Nouvel état pour gérer la couleur de fond
//     const aiChatId = 1; // ID du chat ici
...
//             <Sidebar onChangeBackgroundColor={handleChangeBackgroundColor} /> {/* Passe la fonction à la Sidebar */}

//             <div className="w-full max-w-2xl mx-auto p-4" style={{ backgroundColor }}> {/* Applique la couleur de fond */}
//                 <div className="w-full h-[250px] sm:h-[400px] bg-gray-200 overflow-y-auto p-4">
//                     {messages.map((msg) => (
//                         <div
//                             className={`p-3 mb-3 rounded-lg min-w-[30%] sm:min-w-[20%] w-auto max-w-[70%] sm:max-w-[40%] whitespace-normal ${msg.sender === 'USER' ? 'bg-primary-200 ml-auto text-left' : 'bg-gray-300 mr-auto text-left'}`}
